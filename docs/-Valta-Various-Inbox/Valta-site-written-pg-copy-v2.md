# Valta Website - Full Page Copy (v2)

**Version:** 2.0
**Date:** 2026-02-13
**Source:** Current live site (valta.ca) synced with GitHub
**Note:** Clean copy without change notes or embedded URLs
...
Request Appraisal | Contact Us Today
...
Request Your Appraisal | Schedule a Consultation

---

# **Services**

[Image: services-hero-carousel]
...
Request Storage Appraisal | Contact Us
...
* **Multi-Storey Self-Storage Facilities**
...
Request Commercial Appraisal | Contact Us
...
# APPENDIX: Image Reference Table

This section maps image placeholders used throughout this document to their actual file locations.

## Image Placeholder Mapping

| Placeholder | Page | Section | File Path |
|-------------|------|---------|-----------|
| `[Image: home-hero]` | Home | Hero Section | `/public/images/01-updated-images/Home-Calgary Developments.jpg` |
| `[Image: home-difference-section]` | Home | What Makes Valta Different | `/public/images/01-updated-images/Aparment New Developemt Calgary.jpg` |
| `[Image: about-hero-carousel]` | About | Hero Section | `/public/images/01-updated-images/Apartment Lobby.jpg` |
| `[Image: about-cta]` | About | CTA Section | `/public/images/01-updated-images/Appraisal Req-Apartment Kitchen Interior (2).jpg` |
| `[Image: services-hero-carousel]` | Services | Hero Section | `/public/images/01-updated-images/Aparment New Developemt Calgary.jpg` |
| `[Image: multifamily-hero]` | Services / Multifamily | Hero Section | `/public/images/01-updated-images/Service- Multifamily -Multifamily Mid Rise.jpg` |
| `[Image: selfstorage-hero]` | Services / Self-Storage | Hero Section | `/public/images/01-updated-images/Service- Self-Storage -Self Storage Units - Interior.jpg` |
| `[Image: commercial-hero]` | Services / Commercial | Hero Section | `/public/images/01-updated-images/Service- Commercial-Calgary Commerical Building.webp` |
| `[Image: appraisal-request-hero]` | Appraisal Request | Hero Section | `/public/images/01-updated-images/Appraisal Req-Apartment Kitchen Interior (2).jpg` |
| `[Image: news-hero]` | News & Blog | Hero Section | `/public/images/01-updated-images/News-Aparment New Developemt Calgary.jpg` |
| `[Image: careers-hero]` | Careers | Hero Section | `/public/images/01-updated-images/Career Posting.jpg` |
| `[Image: contact-hero]` | Contact | Hero Section | `/public/images/01-updated-images/Contact-Amenity Rooftop.jpg` |

---

## Notes

- All primary page images are located in `/public/images/01-updated-images/`
- Image paths are relative to the `/public/` directory in the Next.js project
- Placeholder format: `[Image: page-section]` for easy identification
- Additional legacy images available in `/public/images/` if needed

---

**Document Version:** 2.0
**Date:** 2026-02-13
**Self-contained:** Yes (includes content + image references)
